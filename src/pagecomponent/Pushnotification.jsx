...
function Pushnotification(props) {
  ...
  const [createPushNotification, createPushNotificationSet] = useState('');
    ...
    <div>
      <Grid container spacing={3}>
        <Grid item lg={12} md={12} sm={12} xs={12}>
          <Contentbox Title='Push Notification' subTitle='Create Push Notification'>
            <Grid container spacing={3}>
              <Grid item lg={12} md={12} sm={12} xs={12}>
              ...
              <Grid item lg={12} md={12} sm={12} xs={12}>
                <InputLabel id="demo-simple-select-label">Create Push Notification</InputLabel>
                <RichTextEditor
                  styles={{
                    root: { color: '#512774' },
                  ...
                  value={createPushNotification}
                  style={{ minHeight: 200, marginBottom: 15 }}
                  onChange={createPushNotificationSet}
                />
              </Grid>
            </Grid>
            <Button color="secondary" variant="contained">Send Push Notification</Button>
          </Contentbox>
        </Grid>
      </Grid>
    </div>
