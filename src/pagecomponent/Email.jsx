...
function Email(props) {
  ...
  const [emailMesg, emailMesgSet] = useState('');
    ...
    <div>
      <Grid container spacing={3}>
        <Grid item lg={12} md={12} sm={12} xs={12}>
          <Contentbox Title='Email' subTitle='Create Email'>
            <Grid container spacing={3}>
              <Grid item lg={12} md={12} sm={12} xs={12}>
              ...
              <Grid item lg={12} md={12} sm={12} xs={12}>
                <TextField label="Enter Email Subject" name="emailSubject" value={emailSubject} onChange={(e) => { emailSubjectSet(e.target.value) }} fullWidth color="secondary" variant="standard" />
              </Grid>
              <Grid item lg={12} md={12} sm={12} xs={12}>
                <InputLabel id="demo-simple-select-label">Create Email Content</InputLabel>
                <RichTextEditor
                  styles={{
                    root: { color: '#512774' },
                  ...
                  onChange={emailMesgSet}
                />
              </Grid>
            </Grid>
            <Button color="secondary" variant="contained">Send Email</Button>
          </Contentbox>
        </Grid>
      </Grid>
    </div>
